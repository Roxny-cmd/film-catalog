...
class Platform(Base):
    ...
    project_platforms = relationship("ProjectOnPlatform", back_populates="platform")
...
class Project(Base):
    ...
    owner = relationship("User", back_populates="projects")  # явный relationship к User
    ...
    project_platforms = relationship("ProjectOnPlatform", back_populates="project", cascade="all, delete-orphan")
...
class ProjectOnPlatform(Base):
    ...
    project = relationship("Project", back_populates="project_platforms")
    platform = relationship("Platform", back_populates="project_platforms")
